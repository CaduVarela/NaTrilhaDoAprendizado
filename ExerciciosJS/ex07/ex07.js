...
pessoas. Exiba:
    ...
    feminino. (x)
    b. Quantas pessoas são maiores e menores de idade (x)
    c. Qual o homem mais velho e mais novo (x)
    d. Qual a mulher mais velha e mais nova (x)
    e. Quantos homens e quantas mulheres são maiores de idade. (x)
*/

var pessoa = [];
var numMulheres=0, numHomens=0, numPessoasMaiorIdade=0, numPessoasMenorIdade=0, maisVelho, maisNovo, maisVelha, maisNova, numHomensMaiorIdade=0, numMulheresMaiorIdade=0;
...
for (var i=0; i<pessoa.length; i++) {
    if (pessoa[i].sexo == 'm') {
        ...
        if (maisNovo == null || pessoa[i].idade < maisNovo.idade) {
            maisNovo = pessoa[i];
        }
        
        if (maisVelho == null || pessoa[i].idade > maisVelho.idade) {
            maisVelho = pessoa[i];
        }
        ...
        if (maisNova == null || pessoa[i].idade < maisNova.idade) {
            maisNova = pessoa[i];
        }
        
        if (maisVelha == null || pessoa[i].idade > maisVelha.idade) {
            maisVelha = pessoa[i];
        }
